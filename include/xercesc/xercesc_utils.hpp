...
\
	...
	template <class String> inline xercesc::DOMElement * get_xpath(xercesc::DOMDocument * doc, const String & path)                                          { return  get_xpath(doc->getDocumentElement(), forward_as_xml_string(path)); }
